...
router_v1.register(r'(?P<user_id>\d+)/refill', RefillViewSet, basename='refill')
router_v1.register(r'(?P<user_id>\d+)/withdraw', WithdrawViewSet, basename='withdraw')
router_v1.register(r'(?P<user_id>\d+)/transfer', TransferViewSet, basename='transfer')
router_v1.register(
    r'(?P<user_id>\d+)/balance',
